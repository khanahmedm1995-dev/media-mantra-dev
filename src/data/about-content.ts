/** About page — source: `Media Mantra Global Website Content` PDF (May 2026). */
...
export const aboutPuja = [
  ...
  "With over 15 years in communications, she is the strategic and operational backbone of Media Mantra Global. From client strategy to day-to-day operations, Pooja oversees it all with the kind of hands-on leadership that keeps a multi-market agency running like clockwork.",
