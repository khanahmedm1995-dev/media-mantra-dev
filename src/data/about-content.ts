...
export const aboutHeroIntro = [
  "It started in 2012 and two of India's youngest independent founders who dared to be Aggressive, Bold, and Credible, that still run through everything we do. 13 years later, Media Mantra Global operates as a fully integrated communications firm across India, UAE, and Singapore. We combine data-driven content strategy, 360-degree strategy, digital marketing, and influencer marketing. In an industry being rapidly reshaped by AI, we are the influence that the communications world needs by using it to move faster, think sharper, and tell stories that cut through louder than ever before.",
] as const;

export const aboutRecognition = [
  "Something about us that even the entire industry recognised was when Media Mantra was named PR Agency of the Year 2025 at the BW Excel Awards and Best Independent Agency of the Year 2024 at IMAGEXX Awards by Adgully.",
] as const;
...
export const aboutUdit = [
  ...
  "With almost two decades of experience in public relations, Udit began his career with the India Today Group before moving through some of the industry's leading PR agencies in India. Along the way, he developed a clear understanding of how narratives shape perception, and how the right strategy turns visibility into value.",
  ...
  "Under his leadership, Media Mantra has serviced over 120 retainer clients and expanded its footprint beyond India, marking its evolution into a cross-market consultancy.",
] as const;
...
export const aboutPuja = [
  ...
  "With over 15 years in communications, she is the strategic and operational backbone of Media Mantra Global. From client strategy to day-to-day operations, Puja oversees it all with the kind of hands-on leadership that keeps a multi-market agency running like clockwork.",
  ...
  "But awards aren't the story.",
  "They built a communication firm together that could build influence with intent!",
] as const;
